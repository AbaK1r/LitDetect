...
from clearn_logs import remove_incomplete_versions
from data import DataInterface
from model import ModuleInterface
from callbacks import DetectionMetricsCallback, MemoryCleanupCallback, PicRecordCallback
...
def copy_code(tensorboard_logger):
    ...
    :return: None
    """
    src_dirs = [Path('model'), Path('conf'), Path('data'), Path('callbacks')]
